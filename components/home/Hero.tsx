...
export function Hero() {
  return (
    <section className="relative flex min-h-[75vh] items-center overflow-hidden bg-slate-950 text-white pt-28 pb-16 md:pt-36 md:pb-24">
...
// 💡 빌드 에러 방지를 위해 Default export와 Named export를 둘 다 안전하게 허용해 줍니다.
export default Hero;
